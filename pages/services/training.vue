    ...
    <section class="bg-blue-50 py-16">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-600 max-w-2xl mx-auto">
          Equip your team with the knowledge and skills to compete and win in the federal marketplace through comprehensive training programs.
        </p>
      </div>
    </section>
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
          <h2 class="text-2xl font-bold text-gray-900 mb-6">
            Empower Your Team for Federal Contracting Success
          </h2>
          <p class="text-gray-600 mb-8">
            Success in federal contracting requires more than just good intentions—it demands expertise, knowledge, and proven strategies. Our Training & Capacity Building service provides your team with the comprehensive education and practical skills needed to navigate the complex world of government procurement with confidence and competence.
          </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600 text-sm">
              Comprehensive introduction to federal procurement processes, regulations, and key concepts for new contractors.
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600 text-sm">
              Advanced techniques for crafting compelling, compliant proposals that win federal contracts and stand out from competition.
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600 text-sm">
              Hands-on training for SAM.gov, beta.SAM.gov, GSA eBuy, and other critical procurement platforms and tools.
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600 text-sm">
              Strategic approaches to federal market entry, relationship building, and sustainable business growth.
            </p>
          </div>
    ...
    <section class="py-16 bg-blue-700 text-white">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold mb-4">
          Ready to Build Your Team's Federal Contracting Expertise?
        </h2>
        <p class="text-xl mb-8 opacity-90">
          Invest in your team's success with comprehensive training programs designed by experienced federal contracting professionals.
        </p>
...
definePageMeta({
  ...
  description: 'Comprehensive federal contracting training programs. Proposal writing, FAR compliance, procurement systems, and business development training.'
})

// Set head for SEO
useHead({
  title: 'Federal Contracting Training & Capacity Building - True North Federal Solutions',
  meta: [
    { 
      name: 'description', 
      content: 'Expert federal contracting training programs. Proposal writing best practices, FAR compliance, procurement systems navigation, and capacity building.' 
    },
    { 
      name: 'keywords', 
      content: 'federal contracting training, proposal writing training, FAR compliance training, government procurement training, capacity building' 
    }
  ]
})
</script>