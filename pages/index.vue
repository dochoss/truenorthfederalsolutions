<template>
  <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          ...
          <NuxtLink to="/services/contract-setup">
            <UCard variant="subtle"
                   ...
                   interactive
                   padding="md"
                   class="bg-secondary-50 hover:shadow-medium transition-shadow">
              <div class="text-center">
                <UIcon name="i-heroicons-cog-6-tooth"
                       class="w-12 h-12 text-primary-600 mx-auto mb-6" />
                <h3 class="text-xl font-bold text-secondary-900 mb-4">
                  Contracting Readiness & Set-Up</h3>
                <p class="text-secondary-600 mb-6">
                  Get contract-ready with strategic setup and compliance tools.
                  SAM.gov & State Registration Assistance,
                  NAICS & PSC Code Optimization, and Capability Statement
                  Development.
                </p>
          ...
          <NuxtLink to="/services/market-intelligence">
            <UCard variant="subtle"
              ...
              <div class="text-center">
                ...
                <p class="text-secondary-600 mb-6">
                  Find and target the right opportunities before your
                  competition. Bid Matchmaking Services, Opportunity
            ...
            <UCard variant="subtle"
              ...
              <div class="text-center">
                <UIcon name="i-heroicons-pencil-square"
                       class="w-12 h-12 text-primary-600 mx-auto mb-6" />
                <h3 class="text-xl font-bold text-secondary-900 mb-4">Proposal
                  Development & Management</h3>
                <p class="text-secondary-600 mb-6">
                  From RFP to submission — we manage the full proposal
                  lifecycle. Proposal Writing & Management,
                  Bid/No-Bid
            ...
            <UCard variant="subtle"
              ...
              <div class="text-center">
                <UIcon name="i-heroicons-shield-check"
                       class="w-12 h-12 text-primary-600 mx-auto mb-6" />
                <h3 class="text-xl font-bold text-secondary-900 mb-4">Compliance
                  & Regulatory Support</h3>
                <p class="text-secondary-600 mb-6">
                  Navigate the FAR and state-specific requirements with
                  confidence. FAR Compliance Consulting, Contract
                  Risk
            ...
            <UCard variant="subtle"
              ...
              <div class="text-center">
                <UIcon name="i-heroicons-academic-cap"
                       class="w-12 h-12 text-primary-600 mx-auto mb-6" />
                <h3 class="text-xl font-bold text-secondary-900 mb-4">Training &
                  Capacity Building</h3>
                <p class="text-secondary-600 mb-6">
                  Equip your team with the knowledge to compete and win.
                  Customized Government Contracting Training,
                  Proposal Writing Best Practices, and Procurement Systems
                  Navigation.
                </p>
                <UButton variant="outline"
                         size="sm"
    ...
    <div class="bg-secondary-50">
      <UPageSection title="Why Choose True North Federal Solutions?"
                    description="Experience and expertise you can trust"
                    :ui="{
                      title: 'text-3xl sm:text-4xl lg:text-5xl text-pretty tracking-tight font-bold text-secondary-900',
                      description: 'text-base sm:text-lg text-secondary-600'
                    }">
        <template #body>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div v-for="feature in whyChooseFeatures"
                 :key="feature.title"
                 class="text-center">
...
const whyChooseFeatures = [
  ...
  {
    title: 'Certified Acquisition Professional',
    description: 'FAC-C Professional & DAWIA Level III certified with deep knowledge of FAR, cost analysis, and full acquisition lifecycle strategy.',
